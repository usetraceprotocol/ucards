    ...
    <section className="relative w-full overflow-hidden bg-background py-20 border-y border-border">
      ...
      <div className="relative z-10 flex flex-col items-center gap-10">
        <div className="flex flex-col items-center gap-3 px-4">
          ...
          >
            The USDP Ecosystem: Engineered for <span style={{ background: 'var(--gradient-beam)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>Web4</span>
          </h2>
