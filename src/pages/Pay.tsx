 ...
 * is fetched server-side. Visitors can pay through UCARDS, open the
...
const Pay = () => {
  ...
  const pageUrl =
    typeof window !== "undefined" ? window.location.href : "https://ucards.com";
    ...
    <div className="min-h-screen bg-background text-foreground">
      <div className="mx-auto flex min-h-screen max-w-lg flex-col items-center justify-center p-4">
        ...
        <p className="mt-4 text-center text-[10px] text-muted-foreground">
          Powered by UCARDS · transferring on Ethereum (chain {BASE_CHAIN_ID})
        </p>
      </div>
    </div>
  );
