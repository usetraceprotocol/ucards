 ...
 * Default text: "Sent a private payment via UCARDS" (no amount, no recipient)
...
export function ShareCastButton({
  paymentId,
  text = "Sent a private payment via UCARDS",
  className = "",
  ...
  const handleShare = async () => {
    try {
      ...
      if (paymentId) {
        embeds.push(`https://ucards.com/miniapp/pay/${paymentId}`);
      }
