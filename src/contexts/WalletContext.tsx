...
const isProduction = typeof window !== "undefined" && (window.location.hostname === "void402.com" || window.location.hostname === "www.void402.com" || window.location.hostname === "orb402.com" || window.location.hostname === "www.orb402.com" || window.location.hostname === "baseusdp.com" || window.location.hostname === "www.baseusdp.com" || window.location.hostname.endsWith(".vercel.app"));
